...
def summarize_handler():
    ...
    try:
        if file:
            ...
            user_prompt = request.form.get('prompt', 'Summarize this transcript in a single paragraph.') # A simpler default
            
            # CHANGED: The full prompt is now ONLY what the user types, followed by the transcript.
